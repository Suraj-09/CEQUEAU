...
class EvapoMcGuinness: public Evapo
{
public:
  //! Constructeur.
  EvapoMcGuinness();
  EvapoMcGuinness(int latitudeMoyenneBV, int nbCE, int pasParJour);
  ~EvapoMcGuinness();
...
private:
  ...
  float calculerMcGuinness(float tempMoy, float rayExtra) const;
