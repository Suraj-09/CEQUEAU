...
class EvapoPenmanMont: public Evapo
{
public:
  //! Constructeur.
  EvapoPenmanMont();
  EvapoPenmanMont(int latitudeMoyenneBV, int nbCE, int pasParJour);
  ~EvapoPenmanMont();
...
private:
  ...
  float calculerPenmanMont(float tempMoy, float airPressure, float rayonnement, float heatStorage, float humidity, float vitesseVent) const;
};
