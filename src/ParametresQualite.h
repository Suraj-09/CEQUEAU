...
public:
  ...
  /*! Coefficient permettant d'augmenter ou de diminuer
    l'importance de l'évaporation dans le bilan d'énergie */
  float cevapo;
  //! Coefficient convection.
  /*! Coefficient permettant d'augmenter ou de diminuer
      l'importance de la convection dans le bilan d'énergie */
  float cconve;
  //! Critere de gel.
  float crigel;
  ...
  //! couverture du sol par la canopé de la forêt (entre 0.0 et 1.0)
  float ccanope;
  float hombre;
};
