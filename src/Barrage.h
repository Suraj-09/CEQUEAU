...
private:
  ...
  /*!
    ...
    reservoir (m) et le volume emmagasiné (millions de m3).
  */
  ...
  */
  ...
  /*!
    Contient les parametres de la relation entre le le volume emmagasiné (millions de m3),
  ...
  */
  ...
  /*!
    ...
    du reservoir vers au autre carreau à l'interieur du bassin versant.
  */
